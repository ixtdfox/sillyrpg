...
export function deserializeTerrainHeightField(descriptor: SceneGeneratedTerrainDescriptor): TerrainHeightField | null {
...
export function serializeTerrainHeightField(
