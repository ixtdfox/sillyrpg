...
/**
 * Serializer отредактированных высот terrain.
 *
 * Класс переводит SceneDescriptor DTO в TerrainHeightField и обратно.
...
export class TerrainHeightFieldSerializer {
  ...
  /**
   * Превращает TerrainHeightField в JSON-совместимый DTO.
   */
